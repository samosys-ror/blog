    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
               ...
               <ul><li>
Please provide the information below and click submit.</li>
<li>
You will then get the confirmation email. Please open the email and click to activate your user account.</li></ul>
              ...
              <div class="form-group row"style="margin-top: 5%;">
                         ...
                         <div class="form-group row">
                          ...
                          <div class="form-group row"style="margin-top: 5%;">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('name') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required  autofocus onkeypress="return onlyNumberKey(event)">
        ...
        <div class="col-md-4">
            <div class="card">
             ...
             <div class="card-body">
                ...
                <h3><b clas="text-center"> Announcements:</b></h3><br>
<p style="text-align: justify;font-size: 14px">SignifyCRM Release 3.5 is now available for all customers.

SignifyPOS Release 2.9.3 is now available for all customers.</p>
             </div>
